...
resource "azurerm_lb_back_end_address_pool_address" "example" {
...
output "lbbackendaddresspooladdress_id" {
    value = azurerm_lb_back_end_address_pool_address.example.id
}
output "lbbackendaddresspooladdress_name" {
    value = azurerm_lb_back_end_address_pool_address.example.name
}
